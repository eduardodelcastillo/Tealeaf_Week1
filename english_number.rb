# English Number - turns number into its equivalent English word
# eg 22 = 'Twenty-two'
# This is expanded version that accommodates millions
# 20131113
...
puts 'Enter a number and it will be converted to its word equivalent: '
